    ...
    return (
        <div className="flex flex-row md:flex-col">
            <a className='cursor-pointer md:hover:-translate-y-4 transition-all' href={props.deploy} target='_blank'>
                <div className="flex items-center justify-center z-10 text-transparent hover:text-white absolute bg-gradient-to-b from-secondary to-transparent opacity-70 transition-all w-32 h-32 md:w-44 md:h-44 lg:w-56 lg:h-56 xl:w-64 xl:h-64 2xl:w-72 2xl:h-72"/>
